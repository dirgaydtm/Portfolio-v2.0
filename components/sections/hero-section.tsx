...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 hidden h-100 dark:hidden lg:h-200 z-0">
        <LetterGlitch
          smooth={false}
          glitchSpeed={100}
      ...
      {/* Main content */}
      <div className="z-1 mx-auto mb-20 flex max-w-3xl flex-col items-center text-center lg:m-0">
